;; alchemy-manager.clar
;; Alchemy Director - Collaborative Financial Management Protocol

;; This contract enables decentralized groups to create shared financial spaces,
;; track complex expense allocations, manage recurring and one-time expenses, 
;; and facilitate transparent payment settlements on the Stacks blockchain.
